...
<sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
         url = "jdbc:mysql://localhost:3306/flashservices"
         user = "root" password = ""/>
...
<%
    ...
    Usuario usuario = null;   
         try{
        Connection con = con=DriverManager.getConnection("jdbc:mysql://localhost:3306/flashservices","root","");
        PreparedStatement ps = (PreparedStatement) con.prepareStatement("SELECT * FROM usuario");
        ResultSet rs = ps.executeQuery();
        while(rs.next()) {
    
     final String fromEmail = "flashservices1304@gmail.com"; //requires valid gmail id
		  final String password = "rgfalhcloahbtbbw"; // correct password for gmail id
...
Properties props = new Properties();
	      ...
	      msg.setFrom(new InternetAddress("flashservices1304@gmail.com", "Flash Services"));

	      msg.setReplyTo(InternetAddress.parse("flashservices1304@gmail.com", false));
